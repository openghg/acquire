...
__all__ = [
    ...
    "string_to_safestring",
    "safestring_to_string",
    "string_to_list",
    "list_to_string",
    "string_to_dict",
    "dict_to_string",
    "string_to_filepath",
    "string_to_filepath_parts",
    "get_datetime_future",
...
def create_uid(short_uid=False, include_date=None, separator="/"):
    ...
    return create_uuid(short_uid=short_uid, include_date=include_date, separator=separator)
...
def get_datetime_future(weeks=0, days=0, hours=0, minutes=0, seconds=0, timedelta=None):
    ...
    if delta.total_seconds() < 5:
        raise ValueError(
            "The requested delta (%s) is not sufficiently far enough " "into the future!" % str(delta)
        )
