...
class UserCredentials:
    ...
    @staticmethod
    def create(user_uid, password, primary_password, device_uid=None):
        ...
        data = {
            "primary_password": _bytes_to_string(primary_password),
    ...
    def login(credentials, user_uids, remember_device=False):
        ...
        raise UserValidationError(
            "Invalid credentials logging into session '%s' " "with username '%s'" % (short_uid, username)
        )
