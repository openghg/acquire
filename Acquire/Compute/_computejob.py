...
class ComputeJob:
    ...
    def submit(worksheet_uid, request, par, secret, cheque):
        ...
        try:
            credit_notes = cheque.cash(spend=cost, resource="work %s" % worksheet_uid)
        ...
        job._uid = _create_uid(include_date=True, short_uid=True, separator="/")
