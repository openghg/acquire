...
class DirMeta:
    ...
    def location(self):
        ...
        return _Location(drive_guid=self._drive_metadata.guid(), filename=self.name())
    ...
    def drive(self):
        ...
        if self.is_null():
            ...
            raise PermissionError(
                "Cannot get the drive metadata as we don't know " "which drive this directory has come from!"
            )
        else:
            from copy import copy as _copy
