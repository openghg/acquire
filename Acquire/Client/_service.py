...
class Service:
    ...
    def __init__(self, service=None, service_url=None, service_uid=None, service_type=None):
        ...
        if service is not None:
            ...
            try:
                ...
                service = _Wallet().get_service(
                    service_url=service_url, service_uid=service_uid, service_type=service_type
                )
